...
const ernaehrungsplanListe = require('./API/ernaehrungsplanListe')
const forum = require('./API/forum')
const forumListe = require('./API/forumListe')
const meldung = require('./API/meldung')
const meldungListe = require('./API/meldungListe')
...
app.use('/api/ernaehrungsplanListe', ernaehrungsplanListe)
app.use('/api/forum', forum)
app.use('/api/forumListe', forumListe)
app.use('/api/meldung', meldung)
app.use('/api/meldungListe', meldungListe)
